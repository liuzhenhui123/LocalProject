...
$(function () {
    ...
    // 刷新
    $(".dlg_btn_fresh_top").bind("click", freshDialog);
});
var urlList=[];
...
function showDialog(urls) {
    ...
    $("#dlg_content").html("");
	$("#dlg_content").append("<video id='videoElement0' muted></video>");
    // for(j = 0,len=urlList.length; j < len; j++) {
        // $("#dlg_content").append("<video id='videoElement"+j+"' muted></video>");
    // }
    ...
    if (flvjs.isSupported()) {
		...
		console.log(urls);
            var videoElement = document.getElementById('videoElement0');
        ...
        // for(j = 0,len=urlList.length; j < len; j++) {
            ...
            // var videoElement = document.getElementById('videoElement'+j);
            // var flvPlayer = flvjs.createPlayer({
                // type: 'flv',
                // url: urlList[j]
            // },{
...
function freshDialog(){
	...
	$("#dlg_content").append("<video id='videoElement0' muted></video>");
    // for(j = 0,len=urlList.length; j < len; j++) {
        // $("#dlg_content").append("<video id='videoElement"+j+"'></video>");
    // }
    if (flvjs.isSupported()) {
		//console.log(urlList[j]);
            var videoElement = document.getElementById('videoElement0');
